...
var (
	...
	pokwMainConfig = &PoKWConfig{
		Epoch:           30000, // ~24-25h
		Seed:            "0xd4e56740f876aef8c010b86a40d5f56745a118d0908a34e49aec8c0db1cb8fa3",
		MaxWhitelist:    120,
		Committee:       10,
		EmptyBlockDelay: 15,
	}
	// PoKWChainConfig is a default PoKW chain config.
	PoKWChainConfig = &ChainConfig{
		ChainID:             big.NewInt(2337),
		HomesteadBlock:      big.NewInt(0),
		DAOForkBlock:        nil,
	...
	// TestChainConfig is a config for Ropsten
...
type ChainConfig struct {
	...
	PoKW   *PoKWConfig   `json:"pokw,omitempty"`
}
...
// PoKWConfig is an alternative PoW consensus engine configs, based on cryptographic sortition.
type PoKWConfig struct {
	Epoch        uint64 `json:"epoch"`        // num of blocks to reset votes and do a checkpoint
...
// String implements the stringer interface, returning the consensus engine details.
func (c *PoKWConfig) String() string {
	return "pokw"
}
